...
// --------------------------- jsPLumbInstance public API ---------------------------------------------------------
		...
		this.addEndpoint = function(el, params, referenceParams) {
		    	console.log("ENDPOINT PARMAS JSPLUMB BEFORE REFERENCE> "+JSON.stringify(referenceParams));
			referenceParams = referenceParams || {};
			var p = jsPlumb.extend({}, referenceParams);
			console.log("ENDPOINT PARMAS JSPLUMB AFTER REFERENCE> "+JSON.stringify(p));
			jsPlumb.extend(p, params);
			console.log("ENDPOINT PARMAS JSPLUMB AFTER PARAMS> "+JSON.stringify(p));
